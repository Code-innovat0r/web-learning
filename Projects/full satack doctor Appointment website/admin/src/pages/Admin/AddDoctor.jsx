      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            ...
            <div className='flex flex-1 flex-col gap-1 '>
              <p>Doctor password</p>
              <input onChange={(e)=>setPassword(e.target.value)} value={password} className='border rounded px-3 py-2' type={showPassword?'text':'password'} placeholder='Password' required />
              <div className='flex flex-row'>
                <img className='w-6' id='pass' onClick={()=>setShowPassword(!showPassword)} src={showPassword?assets.open_eye:assets.close_eye} alt="" /> 
                <span className='font-bold text-sm'>&nbsp;&nbsp;{showPassword?'Hide Password':"Show Password"}</span>
              </div>
            </div>
            <div className='flex flex-1 flex-col gap-1 '>
              <p>Experience</p>
        ...
        <div>
          ...
          <textarea onChange={(e)=>setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border rounded' placeholder='About doctor..' rows={5} cols={40} required />
        </div>
