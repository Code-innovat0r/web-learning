  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        {/* take the previous and return the not previous */}
        ...
        {showFilter ?<div className='flex flex-col gap-4 text-md text-gray-800'>
        ...
        <div className='grid grid-col-auto lg:grid-cols-5 md:grid-cols-4 sm:grid-cols-3 gap-4 gap-y-6'>
          {
